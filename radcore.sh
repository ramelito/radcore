...
# Default-Stop:      0 1 6
# Short-Description: Radcore startup
# Description:       This file should be used to construct scripts to be
#                    placed in /etc/init.d.
### END INIT INFO

# Author: Anton Komarov <radcore@amelito.com>

# PATH should only include /usr/* if it runs after the mountnfs.sh script
PATH=/sbin:/usr/sbin:/bin:/usr/bin
DESC="Radcore startup script"
NAME=radcore
DAEMON=/opt/bin/$NAME
DAEMON_ARGS="--config /opt/etc/radcore.yml --log-file /opt/var/log/radcore.log"
